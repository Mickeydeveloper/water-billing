// Stream Player Configuration Management
// Add this to server.js to enable the streaming player endpoints

// ================== STREAM PLAYER CONFIGURATION ==================

// In-memory storage for stream configurations (replace with DB later)
let streamChannels = [
    {
        id: 1,
        name: "Azam Two",
